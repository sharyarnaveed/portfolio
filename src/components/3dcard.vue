...
<template>
  <div class="container">
    <!-- 3D Model -->
    <slot ref="canvasContainer" class="model-container"> </slot>
    <!-- Your existing card -->
    <div class="cover atvImg">
      <div
        class="atvImg-layer"
        data-img="https://images.unsplash.com/photo-1559825481-12a05cc00344?q=80&w=1530&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
      ></div>
      <div
        class="atvImg-layer"
        data-img="https://images.unsplash.com/photo-1559825481-12a05cc00344?q=80&w=1530&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
